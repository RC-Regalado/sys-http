FILES = ./build/main.o ./build/io.o ./build/str.o ./build/hashmap.o ./build/mmap.o ./build/memory.o ./build/server.o ./build/requests.o ./build/epoll_loop.o ./build/client.o ./build/files.o ./build/syscalls.o ./build/json.o ./build/database.o ./build/query.o
